...
<body>
    ...
    <div class="container "  >
        <div >
            <div class="subHead">
                ...
                <div style="width: 200px;" class="square">
                    ...
                    <div style="height:auto; display:flex; justify-content: center; " class="bd ">
                    <form action="" method="post">
                     ...
                     <div class= " bg-white col_half mt-2 d-flex">
                        <div class="input_field"> 
                            ...
                            <button style="background-color: #001476; color: white; padding: 0px 7px;" class=" border-0  rounded-2" name="submit" type="submit" >+</button>
                        </div><br>
                        <p>
                        <?php 
                    ...
                    <?php  require "./config.php";
                        ...
                        echo  "<p>Bio About A new Member <span style='color: #001476;' class=' text-decoration-underline fs-2'>".$_SESSION['userName']."</span> </p>" ;
                        ?>
                    </div>
                    <?php  require "./config.php";
        ...
        <div class="postField">
                ...
                <div class="square  mb-2 pe-3 ps-3">
                        ...
                        <div style="height:auto;" class="bd pt-3 pb-3">
                        <?php
                        if ($_GET['id_user']) {
                        $id_user = $_GET['id_user']; } ?>
                            ...
                            <div class="head d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    if ($_GET['id_user']) {
                                        $id_user = $_GET['id_user'];
                                        echo $id_user;
                                        $sql = "SELECT FirstName, LastName from user where id_user = '$id_user' ";
                                        $result = $conn->query($sql);
