    ...
    <div class="container "  >
            ...
            <div class="d-md-flex justify-content-md-between mt-3 ">
                ...
                <div class="ownFriend bg-white col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                    <div  class="square">
                        ...
                        <div style="height:auto;" class="p-2 bd listFriend bg-light  ">
                        <?php 
                            ...
                            if ($result->num_rows > 0) {
                                while ($row =  $result->fetch_assoc()) {
                                    ...
                                    <div class='proFriend'>
                                        ...
                                        <span class=' position-absolute'>Delete</span>
        ...
        <div style="width: 450px;  background-color:#f1f1f1;" class="square  mb-2 pe-3 ps-3">
                ...
                <div style="height:auto;" class="bd p-3 bg-light ">
                    <form class="f-dlex align-items-center" action="Profile.php" method="post">
