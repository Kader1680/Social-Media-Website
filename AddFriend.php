...
if (isset($_POST['submit'])) {
    ...
    $frind = $_POST['friend'];
    $sql = " INSERT INTO friends (NameFriend)".
          "VALUES ('$frind')";
...
<body>
    ...
    <div id="fb">
        ...
        <p id="info">Bertram Gilfoyle<input name="friend" class=" invisible border-0 w-25 bg-transparent border-O" value="Bertram Gilfoyle" type="text">
        <div id="button-block">
            <button name="submit" type="submit" class="btn border-0" id="confirm">Confirm</button>
            <div id="delete">Delete Request</div>
        </div>
    ...
    <div id="fb">
        ...
        <p id="info">Dinesh Chugtai<input name="friend" class=" invisible border-0 w-25 bg-transparent border-O" value="Dinesh Chugtai" type="text">
        <div id="button-block">
            <button name="submit" type="submit" class="btn border-0" id="confirm">Confirm</button>
